...
const LogoTop = () => {
  return (
    <div className="fixed z-[9999] top-7 md:top-10 left-5 md:left-10">
      <Image src="/assets/img/accueil/logoWhite.png" width={200} height={200} alt="" />
    </div>
  );
};
...
const NavLink = ({ children, href, idx }) => {
  return (
    <motion.a
      ...
      exit={{ opacity: 0, y: -8 }}
      href={href}
      className="block text-5xl uppercase font-semibold text-yellow-50 transition-colors hover:text-white md:text-7xl"
    >
      {children}.
    </motion.a>
  );
...
const Logo = () => {
  ...
  return (
    <motion.a
      ...
      exit={{ opacity: 0, y: -12 }}
      href="#"
      className="grid h-20 w-[200px] md:w-[300px] pl-5 md:pl-10 pt-3 md:pt-10 place-content-center rounded-br-xl rounded-tl-xl bg-transparent transition-colors"
    >
      <Image src='/assets/img/accueil/logoWhite.png' width={200} height={200} alt="logo" />
    </motion.a>
  );
};
